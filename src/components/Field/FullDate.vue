<template>
	<div class="row wrap gutter mf-fulldate">
		...
		<div class="width-1of1">
			<input type="date" v-model.trim="value.answer.content" placeholder="Year-Month-Day" @input="update" :class="{'has-error': $v.value.answer.content.$error}" />
			<div>
